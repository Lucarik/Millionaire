...
public class Question7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.q7a1B);
        button2 = findViewById(R.id.q7a2B);
        button3 = findViewById(R.id.q7a3B);
        button4 = findViewById(R.id.q7a4B);
        confirm = findViewById(R.id.conf7B);

        currentTotal = findViewById(R.id.q7Total);
        cWorth = findViewById(R.id.q7Worth);
