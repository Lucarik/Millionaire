...
public class Question6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.q6a1B);
        button2 = findViewById(R.id.q6a2B);
        button3 = findViewById(R.id.q6a3B);
        button4 = findViewById(R.id.q6a4B);
        confirm = findViewById(R.id.conf6B);

        currentTotal = findViewById(R.id.q6Total);
        cWorth = findViewById(R.id.q6Worth);
