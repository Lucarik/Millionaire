...
public class Question8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.q8a1B);
        button2 = findViewById(R.id.q8a2B);
        button3 = findViewById(R.id.q8a3B);
        button4 = findViewById(R.id.q8a4B);
        confirm = findViewById(R.id.conf8B);

        currentTotal = findViewById(R.id.q8Total);
        cWorth = findViewById(R.id.q8Worth);
